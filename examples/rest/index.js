...
var qrCodeBase64 = null; //variável para armazenar o QR code
var qrCodeURL = null; //variável para armazenar a URL do QR code
...
app.get('/qr', async function (req, res) {
  console.log('Solicitou QR code');
  
  var return_object = {
    status: qrCodeBase64 ? true : false,
    qrcode: qrCodeBase64,
    url: qrCodeURL,
    message: qrCodeBase64 ? 'QR code disponível' : 'Aguardando QR code...'
  };
  ...
  await wppconnect
    .create({
      ...
      catchQR: (base64Qr, asciiQR, attempts, urlCode) => {
        ...
        console.log(asciiQR); // Exibe o QR code no console
        console.log('URL do QR Code:', urlCode); // URL para visualizar o QR code
        qrCodeBase64 = base64Qr; // Armazena o QR code em base64
        qrCodeURL = urlCode; // Armazena a URL do QR code
      },
